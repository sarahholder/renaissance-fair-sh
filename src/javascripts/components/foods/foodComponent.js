...
const foodDataCardInfo = (food) => {
  ...
  domString += '</div>';
  domString += '</div>';
  domString += '<button id="editBtn" class="hide">Edit <i class="fas fa-feather-alt"></i></button>';
  domString += '<button id="deleteBtn" class="hide">Delete <i class="far fa-trash-alt"></i></button>';
  domString += '</div>';
  domString += '</div>';
