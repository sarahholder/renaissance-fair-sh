...
const foodDataCardInfo = (food) => {
  ...
  domString += '</div>';
  domString += '<button id="editFoodBtn" class="editFoodBtn">Edit <i class="fas fa-feather-alt"></i></<button>';
  domString += '<button id="deleteFoodBtn" class="deleteFoodBtn">Delete <i class="far fa-trash-alt"></i></button>';
  domString += '</div>';
  domString += '</div>';
  domString += '</div>';
